...
<?php $s_menu_item = "carriage-of-goods"; include '_base/sidebar-menu.php'; ?>

          </div>
          <!-- /.sidebar -->
          <div class="content">
            <div class="content__title">Доставка сборных грузов</div>
            <!-- /.content__title -->
            ...
            <div class="content-feedback content__feedback">
              ...
              <div class="feedback-block content-feedback__block">
                <div class="feedback-block__username">Мария Власова</div>
                <!-- /.feedback-block__username -->
                <div class="feedback-block__text">Наша фирма работает с LTS не так давно, но уже за это небольшое время они показали, что настоящие профессионалы своего дела. В этой фирме нам нравится то, что грамотные специалисты всегда могут предложить различные логистические варианты перевозки грузов, который подойдет конкретному заказчику, а их, поверьте, у них не так мало. Они осуществляют и авиа перевозки и морские перевозки. Очень удобно отслеживать, где находится конкретный груз, если в этом есть какая- то необходимость. Планируем и дальше работать с этой фирмой, и я надеюсь, она нас никогда не подведет.</div>
