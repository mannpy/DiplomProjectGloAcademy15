...
<?php $s_menu_item = "delivery-financing"; include '_base/sidebar-menu.php'; ?>

          </div>
          <!-- /.sidebar -->
          <div class="content">
            <div class="content__title">Финансирование поставок</div>
            <!-- /.content__title -->
            ...
            <div class="content-feedback content__feedback">
              ...
              <div class="feedback-block content-feedback__block">
                <div class="feedback-block__username">Елена Лучинина</div>
                <!-- /.feedback-block__username -->
                <div class="feedback-block__text">Отзыв абсолютно негативный, как и опыт взаимодействия с данной компанией. Все гладко только на уровне консультации. С момента подписания договора на услуги Вы будете в постоянном напряжении и нервном треморе. Сроки оказания услуги, как и первоначально озвученная их стоимость, вырастут в арифметической прогрессии (в лучшем случае) к концу вашего совместного пути. Что бы Вам не говорили, своего автопарка у компании нет, пользуются услугами других, более дешевых перевозчиков, скорее всего региональных. Работают за маржу. То есть, можно найти тех, кто самостоятельно осуществляет Грузоперевозки, а не пользуется услугами «партнеров». При этом Вы сэкономите кучу денег и, главное, нервов, и если Вам дорого и то и другое - подумайте, прежде чем обращаться в эту компанию ию.</div>
                <!-- /.feedback-block__text -->
              </div>
              <!-- /.feedback-block content-feedback__block -->
              <div class="feedback-block content-feedback__block">
                <div class="feedback-block__username">Тимур Галлямов</div>
                <!-- /.feedback-block__username -->
                <div class="feedback-block__text">Компания ответственно подходит к своей работе. Обо всех задержках сразу же сообщают. По срокам практически всегда укладываются </div>
                <!-- /.feedback-block__text -->
              </div>
              <!-- /.feedback-block content-feedback__block -->
            </div>
